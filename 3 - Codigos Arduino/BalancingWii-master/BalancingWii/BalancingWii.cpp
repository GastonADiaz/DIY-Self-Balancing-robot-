...
#define LED_FRENTE A0    // LED para ambos motores adelante
#define LED_ATRAS A1     // LED para ambos motores atrás
#define LED_DERECHA A2   // LED para motor 1 derecha y motor 2 izquierda
#define LED_IZQUIERDA A3  // LED para motor 1 izquierda y motor 2 derecha
